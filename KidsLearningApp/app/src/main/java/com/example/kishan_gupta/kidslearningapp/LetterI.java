    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent in = new Intent(LetterI.this, Main2Activity.class);
                    startActivity(in);
        ...
        forward_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent in = new Intent(LetterI.this, LetterJ.class);
                    startActivity(in);
                }catch (Exception e){
                }
            }
        ...
        backward_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent in = new Intent(LetterI.this, LetterH.class);
                    startActivity(in);
                }catch(Exception e){
        ...
        play_a.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View arg0)
            {
                ...
                try
                {
                    ...
                    MediaPlayer mp = MediaPlayer.create(getApplicationContext(), R.raw.ia);
                    mp.start();
