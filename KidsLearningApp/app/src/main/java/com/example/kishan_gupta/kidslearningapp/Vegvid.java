...
public class Vegvid extends Activity implements SurfaceHolder.Callback{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vegvid);

        Button buttonPlayVideo = (Button)findViewById(R.id.bt_play);
        ...
        String uriPath = "android.resource://com.example.kishan_gupta.kidslearningapp/"+R.raw.vegvid;
        ...
        buttonPlayVideo.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                VideoView mVideoView = (VideoView)findViewById(R.id.videoView2);
                // MediaController4 mediaController= new MediaController4(this);
