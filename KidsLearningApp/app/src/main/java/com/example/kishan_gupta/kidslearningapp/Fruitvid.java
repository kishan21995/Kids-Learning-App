...
public class Fruitvid extends Activity implements SurfaceHolder.Callback{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fruitvid);
        ...
        String uriPath = "android.resource://com.example.kishan_gupta.kidslearningapp/"+R.raw.fruitplay;
        ...
        buttonPlayVideo.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                VideoView mVideoView = (VideoView)findViewById(R.id.videoView);
                // MediaController3 mediaController= new MediaController3(this);
                ...
                //mVideoView.setMediaController(mediaController3);
                // MediaController3.setMediaPlayer(mVideoView);
                mVideoView.setVideoURI(uri);
                mVideoView.requestFocus();
                mVideoView.start();
