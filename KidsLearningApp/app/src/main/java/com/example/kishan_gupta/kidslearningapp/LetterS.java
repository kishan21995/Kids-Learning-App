    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent in = new Intent(LetterS.this, Main2Activity.class);
                    startActivity(in);
        ...
        forward_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent in = new Intent(LetterS.this, LetterT.class);
                    startActivity(in);
                }catch (Exception e){
                }
            }
        ...
        backward_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent in = new Intent(LetterS.this, LetterR.class);
                    startActivity(in);
                }catch(Exception e){
        ...
        play_a.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View arg0)
            {
                ...
                try
                {
                    ...
                    MediaPlayer mp = MediaPlayer.create(getApplicationContext(), R.raw.sa);
                    mp.start();
